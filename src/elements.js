...
const пробаПодполя = (отрисовка, поле, длина, строк) => {
...
function пределЗнаков(отрисовка, поле, s, строк) {
